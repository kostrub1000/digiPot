namespace digiPot
{
    partial class Form1
    {
        ...
        {
            Open_COM_port_button = new Button();
            available_COM_ports_comboBox = new ComboBox();
            ...
            // 
            Open_COM_port_button.Location = new Point(62, 54);
            Open_COM_port_button.Name = "Open_COM_port_button";
            Open_COM_port_button.Size = new Size(138, 23);
            Open_COM_port_button.TabIndex = 0;
            Open_COM_port_button.Text = "Открыть COM порт";
            Open_COM_port_button.UseVisualStyleBackColor = true;
            Open_COM_port_button.Click += Open_COM_port_button_Click;
            // 
            // available_COM_ports_comboBox
            // 
            available_COM_ports_comboBox.FormattingEnabled = true;
            available_COM_ports_comboBox.Location = new Point(215, 54);
            available_COM_ports_comboBox.Name = "available_COM_ports_comboBox";
            available_COM_ports_comboBox.Size = new Size(121, 23);
            available_COM_ports_comboBox.TabIndex = 1;
            // 
            // up_button
            // 
            ...
            // resistance_textBox
            // 
            resistance_textBox.Location = new Point(62, 164);
            ...
            set_resistance_button.Location = new Point(215, 164);
            set_resistance_button.Name = "set_resistance_button";
            set_resistance_button.Size = new Size(169, 23);
            ...
            Controls.Add(available_COM_ports_comboBox);
            Controls.Add(Open_COM_port_button);
        ...
        private ComboBox available_COM_ports_comboBox;
